    ...
    for row in lines[header_idx + 1:]:
        ...
        try:
            ...
            traffic_data = {
                ...
                'discovery_users': safe_int(row, field_cols.get('discovery_users')),
                'discovery_views': safe_int(row, field_cols.get('discovery_views')),
...
def create_pdf_report(csv_file, output_file, dates_file, min_views=0):
    ...
    for i, pr in enumerate(press_releases, 1):
        ...
        table_data.append([
            ...
            format_number(pr['discovery_views']),
        ])
